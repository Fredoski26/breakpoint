   ...
   <section id="breakpoint-section">
      <div className="breakpoint-container">
        <div className="breakpoint-content-left">
          ...
          <h1 className="breakpoint-main-heading">	At Breakpoint Energy Services Limited is a proudly Nigerian-owned, full-spectrum Engineering, Procurement, Construction (EPC), Operations & Maintenance company delivering high-impact technical solutions across the oil, gas, energy, and chemical industries.           </h1>
          ...
          <p className="breakpoint-description">
           we deliver world-class Inspection and Non-Destructive Testing (NDT) services that are engineered to exceed industry standards and client expectations.           </p>
          {/* <p className="breakpoint-description">
